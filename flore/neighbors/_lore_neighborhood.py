...
class LoreNeighborhood(FuzzyNeighborhood):
    ...
    def __init__(self, instance, size, class_name, bb, dataset, X2E, idx_record2explain):
        self.X2E = X2E
        self.dataset = dataset
        self.idx_record2explain = idx_record2explain
    ...
    def fit(self):
        ...
        dfZ, x = dataframe2explain(self.X2E, self.dataset, self.idx_record2explain, self.bb)
